resource "google_cloud_run_v2_service" "api1_service" {
  name     = "ten-wimbledon-p-crs-euwe2a-api1"
  location = "europe-west2"
  ingress  = "INGRESS_TRAFFIC_ALL"

  template {

    service_account = "wimbledown-api1-sa@ten-wimbledon-p-proj.iam.gserviceaccount.com"
    ...
    volumes {
      ...
      cloud_sql_instance {
        instances = [
          "ten-wimbledon-p-proj:europe-west2:ten-wimbledon-p-csql-euwe2a-primary",
        ]
      }
    }
...
resource "google_cloud_run_v2_service" "api2_service" {
  name     = "ten-wimbledon-p-crs-euwe2a-api2"
  location = "europe-west2"
  ingress  = "INGRESS_TRAFFIC_ALL"

  template {

    service_account = "wimbledown-api2-sa@ten-wimbledon-p-proj.iam.gserviceaccount.com"
...
resource "google_cloud_run_v2_service" "web_service" {
  name     = "ten-wimbledon-p-crs-euwe2a-web"
  location = "europe-west2"
  ingress  = "INGRESS_TRAFFIC_ALL"

  template {

    service_account = "wimbledown-web-sa@ten-wimbledon-p-proj.iam.gserviceaccount.com"
